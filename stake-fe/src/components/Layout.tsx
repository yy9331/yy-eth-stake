  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900" />
      ...
      <div className="relative flex flex-col flex-grow">
        ...
        {/* Footer */}
        <footer className="relative bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-t-2 border-red-200/50 dark:border-gray-700/50 mt-auto">
