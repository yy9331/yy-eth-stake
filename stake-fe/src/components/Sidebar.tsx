  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed top-6 left-6 z-50 p-3 bg-gradient-to-r from-red-500 to-orange-500 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
      >
            ...
            >
              ...
              <div className="px-6 mb-8">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-orange-500 rounded-full flex items-center justify-center">
                    <RiFireLine className="w-6 h-6 text-white" />
                  </div>
              ...
              <div className="px-6">
                <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
                  ...
                  <div className="text-sm text-gray-300">Sepolia Testnet</div>
                </div>
              </div>
            </motion.div>
          </>
